...
def submit():
    ...
    cur.execute("insert into company_table values(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)",
                (
                    company_name_var.get(), company_id_var.get(), company_email_var.get(), branch_var.get(),
                    year_var.get(),
                    cgpa_var.get(), company_Phone_no_var.get(), hsc_var.get(), ssc_var.get(), no_of_recruits_var.get()))
    cur.execute("Select * from company_table")
    rows = cur.fetchall()
    for row in rows:
        company_table.insert('', END, values=row)
...
def update():
    ...
    cur.execute(
        ...
        (company_name_var.get(), company_id_var.get(), company_email_var.get(), branch_var.get(), year_var.get(),
         cgpa_var.get(), company_Phone_no_var.get(), hsc_var.get(), ssc_var.get(), no_of_recruits_var.get()))
    cur.execute("Select * from company_table")
    rows = cur.fetchall()
    for row in rows:
...
company_table = ttk.Treeview(table_frame,
                             columns=("Company_name", "Company_ID", "Email_id", "Branch", "Year", "CGPA", "Phone_no",
                                      "no_recruitments", "hsc", "ssc"))
