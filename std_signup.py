...
title = Label(f1,text="Student Sign Up",font=("Time Roman",35,"bold"),bg="white",padx=10,pady=10,relief=RIDGE,bd=10)
title.pack(fill="both")

f2 = Frame(window,width=350,height=200,bg="#37948e")
f2.place(x=220,y=140)

nameL = Label(f2,text='Student name ',padx=5,pady=5,font=('Arial',12,"bold"),bg="#37948e",fg="white")
nameL.place(x=10,y=10)

nameE = Entry(f2,textvariable=name_var,width=25)
nameE.place(x=150,y=14)

regL = Label(f2,text='Student Id',padx=5,pady=5,font=('Arial',12,"bold"),bg="#37948e",fg="white")
